    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
				...
				<a href="" class="h4 text-white">Talk To Us</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Book Appointment</a>
				<i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Contacts</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h3 class="text-white">Liberty Cancer and Wellness Center</h3>
                        <p class="text-white mb-0">Please feel free to contact and/or visit our centre. Our friendly patient care representative will be ready to attend to you, answer any questions and send additional detailed information.</p>
						
						<h3 class="text-white">Our Location</h3>
                        <p class="text-white mb-0">Assumption Centre CDN 3rd floor next to Mercy Mission Hospital, Moi Road, Nakuru Town - Kenya</p>
						
						<h3 class="text-white">Reach Us</h3>
						<p><i class="bi-phone text-white">  0790 658 888   0786 658 888</i></p>
						<p><i class="bi-mailbox text-white">  info@libertycwc.co.ke</i></p>
                       
						
						<h3 class="text-white">Operating Hours</h3>
                        <p class="text-white mb-0">Mon - Fri: 8:00 am - 5:30 pm </br> Saturday: 9.00 am - 12.30 pm</p>
                    </div>
                </div>
                <div class="col-lg-6">
